        ...
        <div class="bg-cream h-screen w-full">
            ...
            <div class="flex justify-between items-center mb-6 w-full p-5">
                ...
                <div class="flex gap-5">
                    ...
                    <div class="relative">
                        <button class="text-gray-600 p-3"  onclick="toggleDropdown()"> <!--Setting icon -->
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <div id="dropdownMenu" class="hidden absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded shadow-md z-50">
